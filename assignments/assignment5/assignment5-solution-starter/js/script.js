...
// STEP 2–4: Builds HTML for the home page with a random category
function buildAndShowHomeHTML (categories) {
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // STEP 3: Replace placeholder in snippet
...
// STEP 2 helper: Choose random category from list
...
// Build and display categories page
...
// Build and show menu items for category
